...
export default function AdministrativePostPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex items-center justify-center p-6 relative z-10 antialiased">
          ...
          <form onSubmit={handleGateUnlock} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-white/[0.08] text-sm text-center text-white placeholder-slate-700 font-mono focus:outline-none focus:border-red-500/60 transition-all tracking-widest appearance-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-white/[0.05] text-xs text-white placeholder-slate-700 focus:outline-none focus:border-amber-500 transition-all appearance-none"
                />
              </div>
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-white/[0.05] text-xs font-bold text-slate-300 focus:outline-none focus:border-amber-500 cursor-pointer transition-all appearance-none"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-white/[0.05] text-xs text-white placeholder-slate-700 font-mono focus:outline-none focus:border-amber-500 transition-all appearance-none"
                />
              </div>
